...
impl Plugin for Ending {
    fn build(&self, app: &mut App) {
        ...
        .add_system_set(SystemSet::on_update(AppState::Ending).with_system(ending_input))
        .add_system_set(SystemSet::on_exit(AppState::Ending).with_system(cleanup_ending));
    }
}
